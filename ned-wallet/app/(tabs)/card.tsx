      ...
      >
          ...
          >
            <View style={styles.menuItemLeft}>
              ...
              <View style={styles.menuItemTextCol}>
                ...
                <Text style={styles.menuItemSubtitle}>Xem chi tiết các giao dịch on-chain</Text>
              </View>
            </View>
        ...
        <View style={styles.groupCard}>
          <TouchableOpacity
            style={styles.menuItemRow}
            activeOpacity={0.7}
            onPress={() => Alert.alert('Mời bạn bè', 'Chia sẻ N.E.D với bạn bè để cùng trải nghiệm thanh toán Web3!')}
          >
            <View style={styles.menuItemLeft}>
